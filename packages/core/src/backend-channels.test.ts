...
const VALID_ARGS = {
  ...
  autoresearchExperiment: ["/project", null, 1],
  autoresearchOverview: ["/project"],
  autoresearchRunLog: ["/project", "tab-1", 1, 2],
  ...
  clearProviderKey: ["/project", "OPENROUTER_API_KEY"],
  clearRemotePassword: [],
  ...
  getProjectMaxConcurrency: ["/project"],
  setProviderKey: ["/project", "OPENROUTER_API_KEY", "key"],
  ...
  setProjectMaxConcurrency: ["/project", 8],
  ...
  transcribeAudio: [{ audioBase64: "AUIATABc", language: null }],
