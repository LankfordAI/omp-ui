...
import { hydrateSessionFile } from "./session-file";
import type { OwnedSessionRecord } from "./types";
import type { watchLineageDir } from "./watcher";
...
export interface WatcherHubDeps {
  ...
  /** The inotify seam; the manager passes core's watchLineageDir so tests can swap it. */
  watch: typeof watchLineageDir;
}
