...
function runtime(queue: unknown[]): RpcTabState {
  return { status: "ready", items: [], transcriptRevision: 0, todos: [], model: null, availableModels: [], commands: [],
    ...
    planHtml: null, planText: null, planDeferred: false, advisorStats: null, mcpStatus: null, advisorReply: true, capabilities: null, capabilitiesLoad: "idle", goal: null, autoresearch: null,
