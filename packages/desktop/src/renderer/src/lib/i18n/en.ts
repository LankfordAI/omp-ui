...
export const en = {
  ...
  "dialog.delete.worktreeDeleted":
    "Its worktree checkout will be removed and the branch {branch} deleted. ",
  "dialog.delete.worktreeAlreadyMerged":
    "Its worktree checkout will be removed. The branch {branch} (already in {destination}) is deleted. ",
  "dialog.delete.worktreeSurvives":
    "Its worktree checkout will be removed. Commits survive on {branch}. ",
  ...
  "dialog.delete.heldElsewhere": "{destination} is checked out in another worktree",
  ...
  "dialog.delete.mergeAborted":
    "the merge would conflict on {n} file(s) and was not applied — delete without merging, or finish the worktree from its tab",
  "dialog.delete.worktreeDirty": "Uncommitted changes in its checkout are lost. ",
  ...
  "dialog.worktree.sourceLabel": "branch",
  "dialog.worktree.sourceNew": "new branch",
  "dialog.worktree.sourceExisting": "existing branch",
  "dialog.worktree.existingBranch": "branch to check out",
  "dialog.worktree.existingHint": "cut point for diffs and merge-back is the repo's default branch",
  "dialog.worktree.noOtherBranches": "no other local branch to check out",
  ...
  "transcript.usage.response": "response: {id}",
  "transcript.image.alt": "attached image {n}",
  "transcript.image.title": "{mimeType} — image {n} of {count}",
  "transcript.tool.imageLabel": "result images",
  "transcript.tool.imageAlt": "tool result image {n}",
  "transcript.tool.imageTitle": "{mimeType} — image {n} of {count}",
  "image.viewer.open": "enlarge image {n}",
  "image.viewer.heading": "image {n} of {count}",
  "image.viewer.dimensions": "{width} × {height} px",
  "image.viewer.previous": "previous image",
  "image.viewer.next": "next image",
  "image.viewer.fit": "fit to window",
  "image.viewer.actual": "actual size",
  "image.viewer.failed": "this image could not be decoded",
  ...
  "selection.contextmenu.copy": "Copy",
  "selection.contextmenu.copyMarkdown": "Copy as Markdown",
  ...
  "composer.slash.goal": "goal — one objective this session works toward on its own",
  "composer.slash.goalSet": "set or replace the goal",
  "composer.slash.goalShow": "show the goal, its budget and what it has spent",
  "composer.slash.goalPause": "stop starting goal turns; the current one may finish",
  "composer.slash.goalResume": "resume the paused goal and continue it",
  "composer.slash.goalDrop": "remove the goal; its usage stays in the session",
  "composer.slash.goalBudget": "set the goal's total token budget, or off",
  "composer.slash.guidedGoal": "the agent interviews you, then sets the goal it agrees on",
  // /autoresearch slash entries (issue #559)
  "composer.slash.autoresearch": "autoresearch experiments: start, lab, off, clear",
  "composer.slash.autoresearchStart": "open the New experiment dialog",
  "composer.slash.autoresearchLab": "open the Lab",
  "composer.slash.autoresearchOff": "leave autoresearch mode",
  "composer.slash.autoresearchClear": "clear the autoresearch session",
  "composer.goal.needsRestart": "Goal commands require restarting this live session with the updated app.",
  "composer.goal.unavailable": "Goal commands are unavailable: {reason}",
  "composer.goal.unavailableUnknown": "this omp build exposes no goal runtime",
  "composer.goal.tooLong": "That goal command is longer than the bridge accepts.",
  ...
  "composer.branch.finishWorktree": "finish worktree…",
  ...
  "settings.omp.mcpFocusFirst":
    "focus a session tab first — the viewer pins to it",
  "settings.omp.sessionCapabilities": "Session capabilities",
  ...
  // BrowserPane
  "browser.sheet.label": "browser pane",
  "browser.toolbar.back": "back",
  "browser.toolbar.forward": "forward",
  "browser.toolbar.reload": "reload",
  "browser.toolbar.stop": "stop loading",
  "browser.toolbar.address": "page address",
  ...
  "browser.agent.attached": "agent connected",
  "browser.agent.acting": "agent acting",
  "browser.state.idle": "enter an address or ask the agent to open a page",
  "browser.state.pending": "opening the browser pane…",
  "browser.state.notLive": "the session is not running — resume it to use the browser pane",
  "browser.state.unavailable": "browser pane unavailable ({reason})",
  "browser.state.noFrames": "no frames received yet",
  ...
  "palette.action.browserPaneDesc": "{title} — the shared page beside the transcript",
  // CommandPalette
  "palette.search.placeholder": "Search sessions, projects, actions…",
  "palette.empty.title": "Nothing matches",
  "palette.empty.hint": "Try fewer letters — matching is fuzzy, not exact.",
  "palette.group.sessions": "Sessions",
  "palette.group.projects": "Projects",
  "palette.group.session": "Session",
  "palette.group.app": "App",
  "palette.action.newSession": "New session in {name}",
  "palette.action.addProject": "Add project…",
  "palette.action.addProjectDesc": "pick a directory to track",
  "palette.action.sessionFallback": "this session",
  "palette.action.terminate": "Terminate agent",
  ...
  "palette.action.newExperiment": "New experiment in {name}",
  ...
  "mcp.header.worktree":
    " — resolved in this session's checkout, written through it to {cwd}",
  "mcp.footer.global": "Changes apply to new sessions in every project.",
  "mcp.footer.project": "Changes apply to new sessions in this project.",
  "mcp.footer.reload": "Reload applies them to this session now.",
  "mcp.footer.oauth":
    "OAuth servers authenticate through omp's TUI: omp refuses reauth over rpc.",
  "mcp.reload.title": "run /mcp reload in this session so it picks up the current MCP config",
  "mcp.reload.titleBusy": "wait for the current turn to finish",
  "mcp.reload.label": "reload MCP in this session",
  "mcp.reload.loading": "reloading…",
  "mcp.panel.loading": "Resolving MCP servers…",
  "mcp.panel.loadingHint": "Reading omp's config sources.",
  "mcp.panel.error": "Could not resolve MCP servers",
  "mcp.panel.retry": "retry",
  "mcp.panel.configErrorOne": "One config file could not be read:",
  "mcp.panel.configErrorMany": "{count} config files could not be read:",
  "mcp.panel.emptyGlobal": "No global MCP servers configured.",
  "mcp.panel.emptyProject": "No MCP servers configured for this project.",
  "mcp.panel.emptyHint":
    "omp resolves native .omp/mcp.json files plus translated cursor, claude, gemini, opencode, windsurf, and vscode configs.",
  "mcp.row.inPlace": "writes enabled:{state} to {path}",
  "mcp.row.disabled": "disabled · {reason}",
  "mcp.row.shadowed": "shadowed by {source}",
  "mcp.row.authFailed": "authentication failed in this session",
  "mcp.row.connectFailed": "connection failed in this session",
  "mcp.reauth.button": "authenticate",
  "mcp.reauth.handoff":
    "hand this session to omp's TUI and run /mcp reauth there — omp refuses OAuth flows over rpc",
  "mcp.row.toggleDisable": "disable {name}",
  "mcp.row.toggleEnable": "enable {name}",
  "mcp.row.pinnedUser":
    "disabled at the user level — enable it globally from Settings → MCP servers",
  "mcp.row.allowlistGlobal":
  ...
  "mcp.row.projectOverride": "writes a project-only override to .omp/mcp.json",
  "mcp.row.toolOwned": "tool-owned file — toggled via omp's user-level override lists",

  "viewer.header.title": "Capabilities",
  "viewer.header.globalKicker": "Global",
  "viewer.header.projectKicker": "Project",
  "viewer.header.session": "Session: {title}",
  ...
  "viewer.search.label": "Search this category",
  "viewer.actions.refresh": "refresh",
  "viewer.actions.refreshTitle": "re-read config and ask the session for a fresh snapshot — live snapshots refresh ~every 2 seconds by themselves",
  "viewer.banner.detached":
    "The pinned session has moved to a different working tree — its live facts and session commands are detached from these {cwd} rows. Close and reopen the viewer to follow it.",
  "viewer.banner.lastKnown": "last known snapshot — the latest refresh failed",
  "viewer.actions.retry": "retry",
  "viewer.state.loading": "reading session…",
  "viewer.state.loadingHint": "The capabilities bridge publishes the roster shortly after boot.",
  "viewer.state.starting": "The session is still starting — the roster arrives once it is live.",
  "viewer.state.bridgeUnavailable": "Skills and Tools require a live native session.",
  "viewer.state.bridgeUnavailableHint":
    "An older OMP build or a failed bridge generation publishes no roster.",
  "viewer.state.terminal":
    "This tab runs an omp TUI — terminal sessions publish no capability roster over rpc.",
  "viewer.state.notLive": "The pinned session is dormant — no live roster to read.",
  "viewer.state.missingSession": "The session this viewer was pinned to no longer exists.",
  "viewer.state.detached":
    "The session moved to a different working tree — its live rosters are detached from this viewer.",
  "viewer.state.error": "The last capabilities refresh failed.",
  "viewer.state.unknown": "unknown",
  "viewer.reason.missingApi": "This OMP build exposes no skill inventory for the session.",
  "viewer.reason.readFailed": "The session failed to read its skill inventory.",
  "viewer.reason.payloadTooLarge":
    "The inventory is too large to publish over the bridge — nothing is listed rather than a partial roster.",
  "viewer.empty.none": "No entries in this category.",
  "viewer.empty.noMatches": "Nothing in this category matches the search.",
  "viewer.row.details": "details",
  "viewer.row.truncated": "(truncated)",
  "viewer.filter.all": "all",
  "viewer.filter.enabled": "enabled",
  "viewer.filter.disabled": "disabled",
  "viewer.filter.unknown": "unknown",
  "viewer.mcp.filterLabel": "configuration state",
  "viewer.mcp.statusConnected": "connected in this session",
  "viewer.mcp.statusPending": "connecting in this session",
  "viewer.mcp.statusUnknown": "status unknown",
  "viewer.mcp.registeredTools": "{count} registered tools",
  "viewer.mcp.runtimeOnly": "Runtime only — not in the resolved config",
  "viewer.skills.loaded": "loaded",
  "viewer.skills.hidden": "hidden",
  "viewer.skills.hiddenUnknown": "hidden metadata: unknown",
  "viewer.skills.filterLabel": "skill listing",
  "viewer.skills.filterListed": "listed",
  "viewer.skills.filterHidden": "hidden",
  "viewer.skills.commands": "skill slash commands {state} in session",
  "viewer.skills.stateEnabled": "enabled",
  "viewer.skills.stateDisabled": "disabled",
  "viewer.skills.coverage": "Loaded means the session roster includes it — not that any turn invoked it.",
  "viewer.skills.unavailableHint": "Skills describe the live session only; the config on disk is not listed here.",
  "viewer.tools.enabled": "enabled",
  "viewer.tools.notEnabled": "not enabled",
  "viewer.tools.direct": "Direct",
  "viewer.tools.xdev": "xd://",
  "viewer.tools.eval": "Eval",
  "viewer.tools.fieldUnknown": "{field}: unknown",
  "viewer.tools.notReported": "access facts not reported: {fields}",
  "viewer.tools.statusFilter": "enabled state",
  "viewer.tools.originFilter": "origin",
  "viewer.tools.clearServer": "clear {server} filter",
  "viewer.tools.unavailableHint": "Tools describe the live session only; unloaded servers list nothing here.",
  "viewer.tools.originAll": "all origins",
  "viewer.tools.originBuiltin": "builtin",
  "viewer.tools.originExtension": "extension",
  ...
  "app.crash.body":
    "The sessions themselves are unaffected — omp keeps running in the background. Reload to reattach.",
  ...
  "tab.exited.exitTitle": "process exit code {code}",
  "tab.exited.exitChip": "exit {code}",
  "tab.exited.dormant":
    "The session is dormant — its transcript is safe on disk. Resume to continue.",
  "tab.exited.resume": "resume session",
  "hud.actions.autoCompact": "auto-compact",
  ...
  "hud.actions.compactTitle": "compact the conversation now",
  "hud.actions.export": "export",
  "hud.actions.exportTitle": "export transcript as html",
  "hud.actions.failureCount": "{count} failed",
  "hud.actions.heading": "actions",
  "hud.actions.capabilities": "Capabilities",
  "hud.actions.capabilitiesFailed": "Capabilities — {count} MCP failures",
  "hud.actions.new": "new",
  "hud.actions.newTitle": "new session in current project",
  "hud.actions.refresh": "refresh",
  "hud.actions.refreshTitle": "refresh state and stats",
  "hud.actions.sessionActions": "session actions",
  "hud.advisor.compactTotal": "{tokens} tok · {spend}",
  "hud.advisor.contextUsage":
    "parent advisor context{model}: {tokens} of {window} tokens ({percent}%) · {billing} · session-tree advisor tokens {totalTokens}",
  "hud.advisor.sessionSpend": "session-tree advisor spend {cost}",
  "hud.advisor.shortLabel": "adv",
  "hud.advisor.subscriptionBilling": "parent advisor uses subscription billing",
  "hud.advisor.subscriptionShort": "sub",
  "hud.advisor.totalUsage": "session-tree advisor usage: {tokens} tokens · {cost}",
  ...
  "hud.metrics.worktree": "worktree",
  "hud.mode.buildDescription":
    "build mode — working-tree writes and state-changing commands are allowed.",
  "hud.mode.buildTitle": "Build mode — working-tree writes and state-changing commands are allowed",
  "hud.mode.noPlanDrafted": "no plan drafted",
  "hud.mode.planDescription":
    "plan mode: read-only exploration — a plan is drafted and reviewed only when you ask",
  "hud.mode.planTitle": "Plan mode — read-only exploration — {plan}",
  "hud.mode.planUnavailable": "plan mode unavailable: {unavailable}",
  "hud.mode.planGoalBlocked": "drop the current goal before entering plan mode",
  "hud.goal.active": "goal",
  "hud.goal.paused": "goal paused",
  "hud.goal.limited": "goal budget reached",
  "hud.goal.complete": "goal done",
  "hud.goal.objective": "goal: {objective}",
  "hud.goal.pausedObjective": "goal paused: {objective}",
  "hud.goal.limitedObjective": "goal out of budget: {objective}",
  "hud.goal.completeObjective": "goal complete: {objective}",
  "hud.goal.usage": "{used} / {budget} tokens",
  "hud.goal.unbounded": "{used} tokens used",
  "hud.goal.openTitle": "open goal controls",
  // Session HUD autoresearch chip (issue #559)
  "hud.autoresearch.on": "autoresearch",
  "hud.autoresearch.run": "run {n}",
  "hud.autoresearch.runOf": "run {n}/{cap}",
  "hud.autoresearch.best": "best {delta}",
  "hud.autoresearch.logPending": "log pending",
  "hud.autoresearch.goal": "autoresearch: {goal}",
  "hud.autoresearch.openTitle": "open the Lab on this experiment",
  ...
  "hud.modes.followUp": "follow-up",
  "hud.modes.followUpHint": "follow-up messages: queued to run after the current turn completes",
  "hud.modes.immediateHint": "interrupt the in-flight tool as soon as a steering message arrives",
  "hud.modes.interrupt": "interrupt",
  "hud.modes.interruptHint": "when steering messages may interrupt tool execution",
  "hud.modes.oneAtATimeHint": "process queued messages one by one, one per turn (recommended)",
  "hud.modes.steering": "steering",
  "hud.modes.steeringHint": "steering messages: what you send while the agent is still running",
  "hud.modes.waitHint": "let the current tool finish, then inject queued steering",
  "hud.retry.abort": "abort retry",
  "hud.retry.abortTitle": "abort an in-flight retry backoff",
  "hud.retry.autoRetry": "auto-retry",
  ...
  "hud.stall.long": "no stream activity for {duration}",
  "hud.stall.short": "stalled {duration}",
  "hud.stats.compact": "{cost} · {tokens} tok · {premium} premium",
  "hud.stats.details": "{cost} · {tokens} tokens · {premium} premium requests",
  "hud.stats.tokenShort": "{tokens} tok",
  "hud.status.compacting": "compacting",
  "hud.status.error": "error",
  "hud.status.hibernated": "hibernated",
  "hud.status.ready": "ready",
  "hud.status.rpcStatus": "rpc status: {status}",
  "hud.status.running": "running",
  "hud.status.starting": "starting",
  "worktree.actions.copy": "copy",
  "worktree.actions.copied": "copied",
  "worktree.actions.openFiles": "Open in Files",
  "worktree.actions.openVsCode": "Open in VS Code",
  "worktree.actions.finish": "finish worktree…",
  ...
  "rail.stats.assistant": "assistant",
  "rail.stats.toolCalls": "tool calls",
  "rail.stats.toolResults": "tool results",
  "rail.stats.total": "total",
  "rail.stats.tokens": "tokens",
  "rail.stats.input": "input",
  "rail.stats.output": "output",
  "rail.stats.reasoning": "reasoning",
  "rail.stats.cacheRead": "cache read",
  "rail.stats.cacheWrite": "cache write",
  "rail.stats.spend": "spend",
  "rail.stats.cost": "cost",
  "rail.stats.premiumReqs": "premium reqs",
  "rail.stats.title": "stats",
  ...
  "rail.session.refreshLabel": "refresh state and stats",
  "rail.session.id": "id",
  "rail.session.file": "file",
  "rail.session.messages": "messages",
  "rail.session.queued": "queued",
  "rail.session.parkedSuffix": " (parked)",
  "rail.session.modelSection": "model",
  "rail.session.model": "model",
  "rail.session.provider": "provider",
  "rail.session.thinking": "thinking",
  "rail.session.context": "context",
  "rail.session.queue": "queue",
  "rail.session.steering": "steering",
  "rail.session.followUp": "follow-up",
  "rail.session.interrupt": "interrupt",
  "rail.session.autoCompact": "auto-compact",
  "rail.session.on": "on",
  "rail.session.off": "off",
  ...
  "rail.plans.paused": "paused · not now",
  "rail.plans.review": "review",
  "rail.plans.requestChangesTitle": "Send the agent back to revise the draft",
  "rail.plans.requestChanges": "request changes",
  "rail.plans.notNowTitle": "Leave the plan pending — the agent stays paused until you answer elsewhere",
  "rail.plans.notNow": "not now",
  "rail.plans.interrupted": "interrupted",
  "rail.plans.interruptedTitle": "The review closed when the session's process ended — re-present it or dismiss it",
  "rail.plans.dismissed": "dismissed",
  "rail.plans.represent": "re-present",
  "rail.plans.representTitle": "Reopen this plan's review — no agent turn is spent",
  "rail.plans.representBusy": "Available once the session is idle and no other review is open",
  "rail.plans.dismiss": "dismiss",
  "rail.plans.dismissTitle": "Stop tracking this plan — its file stays on disk",

  "rail.tabs.todos": "todos",
  "rail.tabs.agents": "agents",
  "rail.tabs.session": "session",
  "rail.tabs.plans": "plans",
  "rail.tabs.diffs": "diffs",
  "rail.chrome.inspector": "inspector",
  "rail.chrome.resize": "resize inspector",
  "rail.chrome.collapse": "collapse inspector",
  "rail.chrome.badgedTitle": "{label} ({count})",

  "diff.rail.readingTitle": "Reading branch…",
  "diff.rail.readingHint": "Gathering the working-tree diff.",
  "diff.rail.errorTitle": "Could not read the diff",
  "diff.rail.retry": "retry",
  "diff.rail.noRepoTitle": "No git repository",
  "diff.rail.noRepoHint": "This project isn't inside a git repo, so there's no branch to diff.",
  "diff.rail.cleanTitle": "Working tree clean",
  "diff.rail.noChangesBase": "No changes on {branch} since {base}.",
  "diff.rail.noChangesHead": "No changes on {branch} since HEAD.",
  "diff.rail.thisBranch": "this branch",
  "diff.rail.detached": "detached",
  "diff.rail.since": "since {base}",
  "diff.rail.refreshLabel": "refresh branch diff",
  "diff.viewer.fallbackName": "diff",
  "diff.viewer.patchLabel": "patch",
  "diff.viewer.showMore": "show {count} more lines",

  "branch.setup.detachedHead": "detached HEAD",
  "branch.setup.newBranch": "new branch",
  "branch.setup.chooseBranch": "choose a branch",
  "branch.setup.gitBranch": "Git branch",
  "branch.setup.currentBranch": "current branch",
  "branch.setup.current": "current",
  "branch.setup.new": "new",
  "branch.setup.existingBranch": "existing branch",
  "branch.setup.switch": "switch",
  "branch.setup.implementOn": "Implement on",
  "branch.setup.noCheckoutHint": "No checkout. Existing working-tree changes stay in place.",
  "branch.setup.createAndSwitch": "Create and switch to",
  "branch.setup.namePlaceholder": "new-branch-name",
  "branch.setup.nameLabel": "new branch name",
  "branch.setup.uncommittedHint": "Uncommitted work carries into the new branch.",
  "branch.setup.filterPlaceholder": "filter branches…",
  "branch.setup.filterLabel": "filter branches",
  "branch.setup.busyWarning": "“{title}” is mid-turn. Switching changes its working tree.",
  "branch.setup.switchAnyway": "switch anyway",
  "branch.setup.cancel": "cancel",

  "branch.merge.oneCommit": "{count} commit",
  "branch.merge.manyCommits": "{count} commits",
  "branch.merge.inProgress": "a merge is already in progress in the project — finish it there: git merge --continue or git merge --abort",
  "branch.merge.resolveHint": "resolve in {cwd}, then git merge --continue — or git merge --abort",
  "branch.merge.sharers": "{count} other session(s) still run in this checkout, so it and the branch are kept until they leave.",

  // FinishWorktreeDialog.tsx (issues #385–#389): destination, outcome, and
  // the session decision — three independent choices in one dialog.
  "finish.dialog.kicker": "Finish worktree",
  "finish.dialog.title": "Finish {branch}?",
  "finish.dialog.loading": "checking the repo…",
  "finish.dialog.facts": "{ahead} ahead of {destination}, {behind} behind",
  "finish.dialog.dirty": "uncommitted changes in the checkout — commit them, or discard them, before returning",
  "finish.dialog.openConsole": "open console",
  "finish.dialog.destination": "where the work goes",
  "finish.dialog.newBranchOption": "new branch…",
  "finish.dialog.newBranchName": "branch name",
  "finish.dialog.newBranchFrom": "cut from",
  "finish.outcome.merge": "merge into {destination}",
  "finish.outcome.keep": "keep the branch",
  "finish.dialog.alreadyIn": "the branch {branch} is already in {destination}",
  "finish.dialog.previewClean": "no conflicts predicted",
  "finish.dialog.previewConflicts": "{count} file(s) would conflict",
  "finish.dialog.previewUnknown": "this git cannot predict conflicts — the merge may still stop",
  "finish.dialog.syncFirst": "sync {destination} into the worktree",
  "finish.dialog.syncBlockedRunning": "this session is mid-turn — pause it before syncing",
  "finish.dialog.syncBlockedDirty": "the checkout is dirty — commit or discard before syncing",
  "finish.dialog.heldElsewhere": "{destination} is checked out in another worktree — pick another destination",
  "finish.dialog.busyProject": "session “{title}” is mid-turn in the project — merging moves {destination} under it",
  "finish.dialog.busySwitchProject": "session “{title}” is mid-turn in the project — returning would move its checkout to {destination}, so the checkout is left alone",
  "finish.dialog.keepHint": "the branch survives the finish; rename it if you like",
  "finish.dialog.renameLabel": "rename branch to",
  "finish.dialog.returnSession": "return this session to {projectCwd}",
  "finish.hint.mergeReturn": "the checkout is removed and the branch {branch} deleted once it is in {destination}",
  "finish.hint.mergeReturnSwitch": "the checkout is removed, the branch {branch} deleted once it is in {destination}, and this session returns on {destination}",
  "finish.hint.keepReturn": "the checkout is removed; the branch {branch} stays",
  "finish.hint.mergeStay": "the session stays in its checkout on {branch}",
  "finish.hint.keepStay": "nothing changes in git; the session keeps running here",
  "finish.dialog.returnBlockedDirty": "the checkout is dirty — commit or discard the changes first",
  ...
  "finish.step.creating": "creating branch…",
  "finish.step.renaming": "renaming…",
  "finish.step.merging": "merging…",
  "finish.step.syncing": "syncing…",
  "finish.step.returning": "returning…",
  "finish.primary.mergeReturn": "merge & return",
  "finish.primary.return": "return",
  "finish.primary.merge": "merge",
  "finish.primary.renameReturn": "rename & return",
  ...
  "notice.merge.conflictAborted": "the merge into {destination} would conflict on {count} file(s) and was aborted — sync {destination} into the worktree, resolve there, then finish again",
  "notice.merge.syncConflicts": "the sync of {source} stopped on {count} file(s) in {path} — resolve them in the worktree, then git merge --continue, then finish again",
  "notice.merge.landed": "merged {branch} ({commits}) into {destination}",
  "notice.finish.switchSkippedBusy": "the project checkout was left on its own branch — session “{title}” is mid-turn there; the work is in {destination}",
  "project.actions.newSession": "New session",
  "project.actions.newTerminal": "New terminal session",
  "project.actions.newWorktree": "New worktree session…",
  "project.actions.settings": "Project settings…",
  ...
  "project.picker.pathHint": "Start with ~/ or an absolute /path.",
  "project.picker.missing": "No such directory",
  "project.picker.denied": "Permission denied",
  "project.picker.noMatches": "No matching directories",
  "project.picker.enterHint": "Enter adds the path shown below.",
  "project.picker.willAdd": "will add:",
  ...
  "project.open.terminal": "Terminal",
  "project.open.opening": "Opening…",
  "project.open.open": "Open",
  "project.open.openProject": "Open {name}",
  "project.open.openProjectIn": "Open {name} in {target}",
  "project.open.checking": "checking how {name} can be opened…",
  "project.open.openPathIn": "open {path} in {target}",
  "project.open.chooseAria": "Choose how to open {name}",
  "project.open.chooseTitle": "choose how to open {name}",
  "project.open.dismissError": "dismiss open error for {name}",
  "project.open.filesDescription":
    "Opens the project directory in the system file manager.",
  "project.open.terminalDescription": "Opens a system terminal at the project root.",

  "project.settings.selectorProvider":
    "use provider/model-id — omp's selectors name the provider",
  "project.settings.selectorLevel":
    "use provider/id — the thinking level follows last-used memory",
  "project.settings.set": "Set",
  "project.settings.emptyClears": "leave empty to clear the pin",
  "project.settings.change": "Change",
  "project.settings.clear": "Clear",
  "project.settings.defaultModel": "Default model",
  "project.settings.mainNotSet":
    "not set — new sessions use the last-used model, then omp's default",
  "project.settings.defaultAdvisor": "Default advisor model",
  "project.settings.advisorNotSet": "not set — last-used, then omp's",
  "project.settings.advisorStartsOff":
    "The advisor starts off for new sessions (last-used off / app default) — the pinned model applies whenever the advisor is on.",
  "project.settings.pinsHint":
    "Pins seed new sessions only. Switching models in a running session updates the last-used memory, never the pin.",
  ...
  "sidebar.status.answerLabel": "answer needed",
  "sidebar.status.answerTitle": "Agent is waiting for your answer",
  "sidebar.status.stalledLabel": "stalled",
  ...
  "sidebar.status.readyLabel": "ready",
  "sidebar.status.readyTitle": "Agent finished output and is ready",
  "sidebar.status.startingLabel": "starting",
  "sidebar.status.startingTitle": "Native session is starting",
  "sidebar.status.errorLabel": "error",
  "sidebar.status.errorTitle": "Native session hit an error",
  "sidebar.status.liveLabel": "live",
  "sidebar.status.liveTitle":
    "Session process is live; detailed activity is unavailable",
  "sidebar.status.dormantLabel": "dormant",
  "sidebar.status.dormantTitle": "Session is dormant",
  "sidebar.status.archivedLabel": "archived",
  "sidebar.status.archivedTitle": "Session is archived",
  "sidebar.status.missingLabel": "missing",

  "sidebar.session.missingHint":
    "session files are gone from disk — delete the record",
  "sidebar.session.implementsFrom": "Implements “{planTitle}” from {sourceTitle}",
  "sidebar.session.implementsUnavailable":
    "Implements “{planTitle}” — source unavailable",
  "sidebar.session.reorder": "reorder {title}",
  "sidebar.session.reorderTitle": "reorder {title} — drag, or Alt+↑ / Alt+↓",
  "sidebar.session.implementation": "implementation",
  "sidebar.session.sourceUnavailable": "source unavailable",
  "sidebar.session.planSource": "plan source",
  "sidebar.session.openPlanning": "open planning session",
  "sidebar.session.stopResumable": "stop the agent (session stays resumable)",
  "sidebar.session.resumeTitle": "resume {title}",
  "sidebar.session.resume": "resume",
  ...
  "sidebar.project.sessions": "{n} sessions",
  ...
  "sidebar.project.newSessionOptions": "new session options for {name}",
  "sidebar.project.remove": "remove project",
  "sidebar.project.noSessions": "no sessions yet",
  "sidebar.project.showing": "showing {shown} of {total}",
  "sidebar.project.showLess": "show less",
  "sidebar.project.moreSession": "{remaining} more session in {name}",
  "sidebar.project.moreSessions": "{remaining} more sessions in {name}",
  "sidebar.project.showMore": "show {n} more",
  ...
  "sidebar.empty.noMatches": "Nothing matches “{query}”",
  "sidebar.empty.noMatchesHint": "No session title or project name contains that.",

  "sidebar.footer.settings": "settings",
  "sidebar.footer.live": "live",
  "sidebar.footer.sessionsOnRecord": "sessions on record",
  "sidebar.footer.session": "{n} session",
  "sidebar.footer.sessions": "{n} sessions",
  "sidebar.footer.resize": "resize project sidebar",
  "settings.shell.application": "Application",
  ...
  "remoteinstances.page.title": "Remote instances",
  ...
  "remoteinstances.field.urlToken": "The pasted link carries an access token; no password is needed.",
  "remoteinstances.field.nickname": "Nickname",
  "remoteinstances.field.nicknameHint": "Defaults to {host}",
  "remoteinstances.field.password": "Password",
  "remoteinstances.field.token": "Access token",
  "remoteinstances.field.secretKind": "Sign in with",
  "remoteinstances.field.secretKeep": "Leave blank to keep the stored credential.",
  "remoteinstances.action.add": "Join",
  "remoteinstances.action.adding": "Joining…",
  "remoteinstances.action.edit": "Edit",
  "remoteinstances.action.save": "Save",
  ...
  "remoteinstances.status.connecting": "connecting",
  "remoteinstances.status.joined": "joined",
  "remoteinstances.status.unreachable": "unreachable",
  "remoteinstances.status.needsSignIn": "sign-in required",
  "remoteinstances.status.self": "this app",
  "remoteinstances.status.incompatible": "incompatible version",
  "remoteinstances.empty.projects": "No projects registered on {nickname}",
  "remoteinstances.empty.instances": "No remote instances joined",
  "remoteinstances.empty.instancesHint": "Paste the connection URL of another omp-ui app below to see its projects here.",
  "remoteinstances.banner.unreachable": "{nickname} is unreachable — reconnecting…",
  ...
  // Lab (CONTEXT.md, issue #559): the experiments surface, its cards and detail.
  "lab.header.title": "lab",
  "lab.header.scope": "project scope",
  "lab.header.allProjects": "all projects",
  "lab.header.refresh": "refresh experiments",
  "lab.header.close": "close the Lab",
  "lab.header.newExperiment": "New experiment",
  "lab.header.newExperimentScopeHint": "scope the Lab to one project to start an experiment in it",
  "lab.overview.loading": "reading experiments…",
  "lab.overview.empty": "No experiments yet. Start one with New experiment or /autoresearch start in a session.",
  "lab.overview.settingUp": "setting up",
  "lab.overview.unsupportedHost": "this host does not support experiments",
  "lab.overview.checkoutError": "could not read {cwd}: {error}",
  "lab.error.notLive": "the experiment's session is not running",
  "lab.error.notNative": "autoresearch controls need a native session",
  "lab.state.running": "running",
  "lab.state.awaitingLog": "awaiting log",
  "lab.state.on": "on",
  "lab.state.off": "off",
  "lab.state.dormant": "dormant",
  "lab.state.closed": "closed",
  "lab.card.best": "best {delta}",
  "lab.card.run": "run {n}",
  "lab.card.runOf": "run {n}/{cap}",
  "lab.detail.back": "experiments",
  "lab.detail.loading": "reading the experiment…",
  "lab.detail.notFound": "this experiment is no longer in the database",
  "lab.detail.openSession": "Open session",
  "lab.detail.stop": "Stop",
  "lab.detail.resume": "Resume",
  "lab.detail.newSegment": "New segment",
  "lab.detail.land": "Land the winner",
  "lab.detail.branchDiff": "Branch diff",
  "lab.detail.runs": "runs",
  "lab.detail.noRuns": "no runs logged yet",
  "lab.detail.notes": "notes",
  "lab.detail.viewLog": "view log",
  "lab.detail.hideLog": "hide log",
  "lab.detail.logLoading": "reading the log…",
  "lab.detail.logTruncated": "log truncated to its head",
  "lab.detail.baseline": "baseline",
  "lab.detail.segment": "segment {n}",
  "lab.detail.command": "command",
  "lab.detail.scope": "scope paths",
  "lab.detail.offLimits": "off-limits",
  "lab.detail.constraints": "constraints",
  "lab.detail.flagged": "flagged",
  "lab.detail.modifiedPaths": "modified paths",
  "lab.detail.scopeDeviations": "scope deviations",
  "lab.detail.justification": "justification",
  "lab.detail.expand": "show run {n} details",
  "lab.detail.collapse": "hide run {n} details",
  "lab.detail.colRun": "#",
  "lab.detail.colStatus": "status",
  "lab.detail.colMetric": "metric",
  "lab.detail.colDuration": "duration",
  "lab.detail.colCommit": "commit",
  "lab.detail.colDescription": "description",
  "lab.run.keep": "kept",
  "lab.run.discard": "discarded",
  "lab.run.crash": "crashed",
  "lab.run.checksFailed": "checks failed",
  "lab.run.pending": "pending",
  "lab.run.abandoned": "abandoned",
  "lab.run.timedOut": "timed out",

  // NewExperimentDialog.tsx (issue #559)
  "experiment.dialog.kicker": "new experiment",
  "experiment.dialog.title": "New experiment in {name}",
  "experiment.dialog.goal": "What to optimize",
  "experiment.dialog.goalPlaceholder": "e.g. reduce the p95 latency of the /search endpoint",
  "experiment.dialog.metric": "Metric name",
  "experiment.dialog.metricHint": "letters, digits, _ . and - (what METRIC name=value accepts)",
  "experiment.dialog.metricInvalid": "metric name may only contain letters, digits, _ . and -",
  "experiment.dialog.unit": "Unit",
  "experiment.dialog.direction": "Direction",
  "experiment.dialog.lower": "lower is better",
  "experiment.dialog.higher": "higher is better",
  "experiment.dialog.command": "Benchmark command",
  "experiment.dialog.commandHint": "empty: the agent writes ./autoresearch.sh",
  "experiment.dialog.scopePaths": "Scope paths",
  "experiment.dialog.offLimits": "Off-limits",
  "experiment.dialog.constraints": "Constraints",
  "experiment.dialog.onePerLine": "one per line",
  "experiment.dialog.maxIterations": "Max iterations per segment",
  "experiment.dialog.model": "Model",
  "experiment.dialog.where": "Where it runs",
  "experiment.dialog.whereGit": "in a new worktree on branch",
  "experiment.dialog.whereNone":
    "not a git repository: no branch isolation, baseline reset, or auto-commits — the experiment runs at the project checkout",
