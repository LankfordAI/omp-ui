...
export const en = {
  ...
  "branch.merge.merging": "merging…",
  "branch.merge.returning": "returning…",
  "branch.merge.mergeInto": "merge into {destination}",
  ...
  "branch.merge.openConsole": "open console",
  "branch.merge.conflictCount": "merge stopped — {count} file(s) conflict",
  "branch.merge.resolveHint": "resolve in {cwd}, then git merge --continue — or git merge --abort",
  "branch.merge.branchGone": "branch {branch} no longer exists — nothing to merge",
  "branch.merge.baseGone": "base {base} no longer resolves — merge manually",
  "branch.merge.noBranchMatch": "no local branch matches base {base} — merge manually",
  "branch.merge.notReadableRepo": "the project is not a readable git repo — merge manually",
  "branch.merge.checkoutFirst": "check out {destination} in the project to merge back",
  "branch.merge.returnTo": "return to {destination}",
  "branch.merge.busyWarning": "session “{title}” is mid-turn in the project — merging moves {destination} under it. The merge also returns this session to {destination}: the checkout and branch are removed, the session is kept.",
  "branch.merge.mergeReturnAnyway": "merge & return anyway",
  "branch.merge.cancel": "cancel",
  "branch.merge.successHint": "a successful merge returns this session to {destination} — the checkout and the branch are removed, the session and its transcript are kept",
  "branch.merge.irreversible": "Irreversible action",
  "branch.merge.confirmTitle": "Merge {branch} into {destination} and return this session to it?",
  "branch.merge.mergeReturn": "merge & return",
  "branch.merge.confirmCommit": "Writes a merge commit in the project checkout recording the {count} committed change(s) on {branch} — their subjects and any issues they close. Uncommitted changes in the worktree are not included.",
  "branch.merge.confirmCleanup": "This session then returns to {destination} in {cwd}: its agent restarts there with its transcript intact. The checkout {path} is removed — uncommitted changes there are lost — and the branch {branch} is deleted.",
  "branch.merge.sharers": "{count} other session(s) still run in this checkout, so it and the branch are kept until they leave.",
  "branch.merge.returnCleanup": "This session returns to {destination} in {cwd}: its agent restarts there with its transcript intact. The checkout {path} is removed — uncommitted changes there are lost — and the branch {branch} is deleted.",
  "branch.merge.conflictedResult": "A conflicted merge stops both the merge and the return: the project checkout is left with files to resolve, and this session stays on {branch}.",
  "branch.merge.returnTitle": "Return this session to {destination}?",
  "branch.merge.alreadyIn": "The branch {branch} is already in {destination}.",
