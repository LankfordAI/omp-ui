...
export const en = {
  ...
  "palette.action.mcp": "MCP servers…",
  "palette.action.mcpDesc": "inspect and toggle MCP servers for this session's working tree",
  ...
  // McpManager / McpServersPanel
  "mcp.header.title": "MCP servers",
  "mcp.header.global": "Global integrations",
  "mcp.header.project": "Project integrations",
  ...
  "hud.actions.manageMcp": "manage MCP servers",
  "hud.actions.manageMcpFailed": "manage MCP servers ({count} failed)",
  "hud.actions.new": "new",
