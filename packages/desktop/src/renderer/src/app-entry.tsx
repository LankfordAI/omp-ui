...
// The React mount, shared by both clients. Importing this module is what creates the root, so a
// boot shim (web/main.web.tsx, ./main.tsx) must have installed window.ompBackend before it loads.
