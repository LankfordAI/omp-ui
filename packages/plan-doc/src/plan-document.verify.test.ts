...
// jsdom for the DOM the probe path would need. No real layout happens here:
// every probe verdict is delivered through the injected LayoutProbe, which is
// exactly the seam §3 gives the reviewed pipeline.
