...
Nothing since [v0.12.4](https://github.com/LankfordAI/omp-ui/releases/tag/v0.12.4). Add one bullet per shipped change here before cutting the next tag; they become that release's Highlights verbatim.
